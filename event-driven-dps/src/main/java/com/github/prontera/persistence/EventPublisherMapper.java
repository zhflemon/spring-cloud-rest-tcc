...
public interface EventPublisherMapper extends CrudMapper<EventPublisher> {
	 ...
	 */
	Set<EventPublisher> selectLimitedEntityByEventStatus(@Param("eventStatus") EventStatus eventStatus,
	 ...
	 */
	Set<EventPublisher> selectLimitedEntityByEventStatusBeforeTheSpecifiedUpdateTime(
			@Param("eventStatus") EventStatus eventStatus, @Param("limited") int limited,
			@Param("beforeThisTime") OffsetDateTime beforeThisTime);
